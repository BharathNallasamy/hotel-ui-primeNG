...
// //     this.value1 = today; // Check-in is today

// //     const tomorrow = new Date(today);
// //     tomorrow.setDate(today.getDate() + 1);
// //     this.value2 = tomorrow; // Check-out is tomorrow
...
// //     //     .subscribe((data) => {
// //     //       this.hotels = data;
// //     //       console.log('Hotels in selected city:', this.hotels);
// //     //     });
...
// //           console.log('Hotels in selected city:', this.filteredHotel);
...
// //         this.rangeValues = [value, this.rangeValues[1]]; // New array reference
// //       }
// //     } else {
// //       if (value >= this.rangeValues[0] && value <= this.maxPrice) {
// //         this.rangeValues = [this.rangeValues[0], value]; // New array reference
// //       }
// //     }
// //   }
...
// //     const ratingMatches = filtered.filter(
// //       (hotel) => hotel.rating === selectedRating
// //     );

// //     if (ratingMatches.length > 0) {
// //       filtered = ratingMatches;
// //     } else {
// //       filtered = []; // No hotels match the rating
// //     }
// //   }
