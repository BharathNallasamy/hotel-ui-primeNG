...
//   navigateToHotelDetails(hotelId: Hotel): void {
//     this.syncToService();
//     this.router.navigate(['/hotel-details', hotelId.slug]);
//   }
...
import { PrimeNgModule } from '../../../primengModule/primeng.module';
import { Subject, takeUntil } from 'rxjs';
import { CityOption, HotelSearchParams } from '../../interfaces/user.interface';
